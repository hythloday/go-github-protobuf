...
type PullRequest struct {
	...
	Labels            []*Label       `protobuf:"bytes,37,rep,name=labels" json:"labels,omitempty"`
}
...
func (m *PullRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Labels) > 0 {
		for _, msg := range m.Labels {
			...
			dAtA[i] = 0x2
			i++
			i = encodeVarintPullRequest(dAtA, i, uint64(msg.Size()))
...
var fileDescriptorPullRequest = []byte{
	...
	,
}
